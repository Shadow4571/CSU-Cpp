...
public:
    ...
    Matrix(Matrix &createFrom) {
        this->width = createFrom.getWidth();
        this->height = createFrom.getHeight();
        this->clear();
        this->fillFrom(createFrom.getMatrix());
    }
    ...
    Matrix(vector<vector<double>> &createFrom) {
